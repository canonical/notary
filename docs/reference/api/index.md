...
| [**Cluster**](cluster.md)                               | Represents the members of a highly available Notary deployment, identity-bound join tokens for join preflight, and the designated ACME issuer. Available only when clustering is enabled.                                                                                                                                                                              |
