...
func NewHandler(config *HandlerConfig) http.Handler {
	...
	// apiV1Router.HandleFunc("POST /certificate_requests/{id}/sign", adminOrUser(config.JWTSecret, SignCertificateRequest(config))) TODO
	...
	apiV1Router.HandleFunc("POST /certificate_requests/{id}/certificate/renew", adminOrUser(config.JWTSecret, RenewCertificate(config)))
	...
	// apiV1Router.HandleFunc("POST /certificate_authorities/{id}/sign", adminOnly(config.JWTSecret, SignCertificateAuthority(config))) TODO
