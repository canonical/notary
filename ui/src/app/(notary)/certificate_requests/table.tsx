...
export function CertificateRequestsTable({
  ...
  const mutationFunc = (
    mutation: UseMutationResult<any, unknown, RequiredCSRParams, unknown>,
            ...
            <>
              ...
              <ContextualMenu hasToggleIcon position="right">
                <span className="p-contextual-menu__group">
                  ...
                  >
                    {isCSRContentVisible
                      ? "Hide Certificate Request Content"
                      : "Show Certificate Request Content"}
                  </Button>
                  <Button
                    className="p-contextual-menu__link"
