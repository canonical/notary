            ...
            <div className="p-panel" style={{
                ...
                <div className="p-panel__content">
                    <div className="u-fixed-width">
                        <form className={"p-form-validation " + ((!passwordsMatch || !passwordIsValid(password1)) && password2 != "" ? "is-error" : "")}>
                            <fieldset>
                                ...
                                {!passwordsMatch && password2 != "" && <p className="p-form-validation__message">Passwords do not match</p>}
                                {passwordsMatch && !passwordIsValid(password1) && password2 != "" && <p className="p-form-validation__message">Password is not valid</p>}
                                {errorText &&
